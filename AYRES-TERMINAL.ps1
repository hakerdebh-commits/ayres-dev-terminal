# AYRES DEV TERMINAL 4.2.7 - launcher PowerShell, ASCII-only.
$ErrorActionPreference = 'Stop'
$Host.UI.RawUI.WindowTitle = 'AYRES DEV TERMINAL 4.2.7'
...
function Header {
  ...
  Write-Host '  | ( A | Y | R | E | S | - | 4 | . | 2 | . | 7 )        |' -ForegroundColor Cyan
  Write-Host '  |  \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/      |' -ForegroundColor Green
  Write-Host '  |                                                        |' -ForegroundColor DarkGreen
...
do {
  Header
  Write-Host '[1] Entrar no painel completo AYRES DEV 4.2.7' -ForegroundColor Green
  ...
  Write-Host '[9] Testar IP publico a partir de outra internet' -ForegroundColor Cyan
